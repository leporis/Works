...
\fancyhead[R]{\small\color{textmedium}v1.2.1.3}
\fancyfoot[C]{\thepage}
...
\begin{center}
    ...
    {\Large 사용설명서}\\[6pt]
    {\large\color{textmedium} v1.2.1.3}\\[20pt]
\end{center}
...
\textbf{v1.2.1.3} & \textbf{2026-02-01} & \textbf{18:50} & \textbf{패치} & \textbf{테이블 색상 렌더링 버그 수정} & \textbf{Claude} \\
\bottomrule
\end{tabular}
\end{center}
...
\vfill
\begin{center}
\textit{사과 가격 예측 선형 회귀 시뮬레이터 사용설명서 v1.2.1.3}
\end{center}

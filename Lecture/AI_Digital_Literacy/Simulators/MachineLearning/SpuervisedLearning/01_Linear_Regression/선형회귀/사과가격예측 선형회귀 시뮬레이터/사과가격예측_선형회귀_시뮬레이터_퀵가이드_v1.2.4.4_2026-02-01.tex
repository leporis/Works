...
% 제목 페이지
\begin{center}
    {\Huge\bfseries\color{applered} 사과 가격 예측 시뮬레이터}\\[0.5cm]
    {\LARGE\bfseries 퀵가이드}\\[1cm]
    {\large 당도와 무게로 계산된 \textbf{품질 점수}로 사과 가격을 예측해보세요!}\\[1cm]
    \colorbox{applered}{\color{white}\bfseries\large\ \ v1.2.4.4\ \ }\\[1.5cm]
\end{center}
...
\begin{tabular}{clcc}
    ...
    \midrule
    \textbf{1} & \colorbox{applered}{\color{white}\small\ 데이터 생성\ } 버튼 클릭 & 점들이 나타났나요? & $\square$ \\[3pt]
